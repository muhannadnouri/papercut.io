...
- Library gallery and list views mark documents that have an explicit reader bookmark; bookmark creation and removal still happen only in the document viewer.
