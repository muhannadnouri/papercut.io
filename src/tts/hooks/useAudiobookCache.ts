    ...
    void (async () => {
      ...
      try {
        ...
        logTtsDiagnostic('[tts-save] completed', {
          ...
          requestedExecutionProvider: result.requestedExecutionProvider,
          effectiveExecutionProvider: result.effectiveExecutionProvider,
          dir: result.dir,
  ...
  function handleNativeProgress(progress: NativeAudiobookSaveProgress, options: TtsOptions): void {
    ...
    if (progress.status === 'saving' && progress.chunkNumber && !progress.generateMs) {
      logTtsDiagnostic('[tts-save] native chunk start', {
        ...
        requestedExecutionProvider: progress.requestedExecutionProvider,
        effectiveExecutionProvider: progress.effectiveExecutionProvider,
        dtype: resolveTtsDtype(options),
        threadCount: options.threadCount,
