...
- Import up to 500 HTML, EPUB, PDF, TXT, or Markdown files at once, paste plain text directly into a searchable local document, or drop supported files onto the desktop Library; desktop builds can also import one folder.
