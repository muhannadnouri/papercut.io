...
- Import up to 500 HTML, EPUB, PDF, TXT, or Markdown files at once, or paste plain text directly into a searchable local document; desktop builds can also import the supported files inside one folder.
